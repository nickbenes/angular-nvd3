...
**NB:** This fork contains modifications to the Angular-nvD3 library that support projects on which I am working. In particular, it supports [my fork of NVD3](https://github.com/nickbenes/nvd3). For the original, please visit [https://github.com/krispo/angular-nvd3].
